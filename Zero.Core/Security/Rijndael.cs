...
namespace Zero.Core.Security
{
	public class Rijndael
	{
		...
		private static string _randomKeyText = "zero of the word";

		/// <summary>
		/// Convert random key byte array into a ASCII string
		/// </summary>
		/// <param name="bytes"/>Random key byte array to be converted.
		...
		/// </summary>
		/// <param name="randomKeyText"/>Random key string to be converted.
		...
		public static string Encrypt(string plainText)
		{
			...
			_randomKeyText = GetString(keyBytes);
		...
		/// </summary>
		/// <param name="cipherText"/>Base64-formatted text value.
		/// <param name="randomKeyText"></param>
